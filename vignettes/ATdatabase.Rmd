...
the time range `r start_data` to `r end_date`. The download_data_fun
...
ts <- as.numeric(start_date)
te <- as.numeric(end_date)

req_matrix <- matrix(c(ts, te), ncol = 2)
ranges <- get_available_time_ranges(statname, dbconn)
